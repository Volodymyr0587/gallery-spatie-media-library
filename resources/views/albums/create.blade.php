                            ...
                            <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                                <form action="{{ route('albums.store') }}" method="POST">
                                  ...
                                  <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                      <input type="text" id="title" name="title" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal sm:text-sm sm:leading-5" />
                                    </div>
                                    @error('title')
